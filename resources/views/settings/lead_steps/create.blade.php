@extends('layouts.app')
@section('title', 'Add Lead Step')
@section('content')

  <div class="gs-page-topbar">
    <div class="gs-page-topbar-left">
      <h2>Add Lead Step</h2>
      <p>Create a new lead step option</p>
    </div>
  ...
  <form method="POST" action="{{ route('settings.lead-steps.store') }}">
    @csrf
        ...
        <div class="gs-panel">
          ...
          <div class="gs-panel-body" style="display:flex; flex-direction:column; gap:10px;">
              <button type="submit" class="gs-btn gs-btn--primary" style="width:100%; justify-content:center;">
                <i class="bi bi-check-lg"></i> Create Lead Step
              </button>
