          ...
          <div class="gs-panel-body">
            ...
            <div class="gs-field">
              ...
              <input type="text" name="name" class="gs-input @error('name') gs-input--error @enderror"
                value="{{ old('name', $template->name) }}" placeholder="e.g. Default LOA, Welcome Email">
              @error('name')
            ...
            <div class="gs-field" id="subjectField" style="margin-top:16px;">
              ...
              <input type="text" name="subject" class="gs-input" value="{{ old('subject', $template->subject) }}"
            ...
            <div class="gs-field" style="margin-top:16px;">
              ...
              <textarea name="content" id="editor" rows="18">{{ old('content', $template->content) }}</textarea>
          ...
          <div class="gs-panel-body" style="display:flex; flex-direction:column; gap:14px;">
            ...
            <div class="gs-field">
              ...
              <select name="type" id="typeSelect" class="gs-select">
                <option value="loa"   {{ old('type', $template->type) === 'loa' ? 'selected' : '' }}>LOA</option>
